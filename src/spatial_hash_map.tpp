...
template <typename T>
void SpatialHashMap<T>::forEach(std::function<bool(SpatialCell<T> &)> func, Rectangle rect) {
...
template <typename T>
void SpatialHashMap<T>::forEach(std::function<bool(SpatialCell<T> &)> func) {
...
template <typename T>
void SpatialHashMap<T>::insert(T item, Rectangle rect) {
...
template <typename T>
void SpatialHashMap<T>::update(T item, Rectangle rect) {
	remove(item);
	insert(item, rect);
}

template <typename T>
void SpatialHashMap<T>::replace(T item, T t) {
...
template <typename T>
void SpatialHashMap<T>::remove(T item) {
...
template <typename T>
SpatialCell<T> SpatialHashMap<T>::nearby(Rectangle rect) {
